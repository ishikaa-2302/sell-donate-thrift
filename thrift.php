...
<html lang="en">
  ...
  <body class="bg-dark">
    ...
    <div class="container bg-success" style="margin-top:1%;">
      <marquee><p style="font-family: Impact; font-size: 15pt">Affordable rates | Awesome collection | Start Thrifting🛒</p></marquee>
      <a href="sell.php" class="btn btn-warning btn-block text-white"><b>Join them. Sell your old clothes👚</b></a>
    </div>
          ...
          if($check){
            while($row = mysqli_fetch_array($query_run))
            {
              ...
              <div class="col-md-3 mt-3">
                <div class="card">
                  <img src="upload1/<?php echo $row['file'];?>" width="200px" height="200px" alt="clothes for selling" ><hr>
                  <div class="card-body">
                    <p>Listed By: </p><h3 class="card-title"><?php echo $row['name'];?></h3><hr>
