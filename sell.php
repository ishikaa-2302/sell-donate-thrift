...
<html lang="en">
  ...
  <body class="bg-dark">
    ...
    <div class="container" style="margin-top: 4%;background-color:#faf0be;">
      ...
      <h5>Sell them to gain💰</h5>
      <h6>How it works?</h6>
      <ul>
        <li>Fill the form given below</li>
        <li>Your product will be featured <a href="thrift.php">here</a></li>
        <li>People can see your products and contact you directly if interested.</li>
      </ul>
    ...
    <form class="needs-validation" enctype="multipart/form-data" action="action1.php" method="post" novalidate>
      ...
      <div class="form-group row">
          ...
          <div class="col-sm-9">
              <input name="phone" type="phone" class="form-control" id="phone" placeholder="We'll address this number to the people who're interested in buying your clothes" required>
          </div>
      </div>
      ...
      <div class="form-group row">
        <label class="col-sm-3 col-form-label" for="price">Price you want to sell:</label>
        <div class="col-sm-9">
          <input name="price" type="price" class="form-control" name="price" id="price" placeholder="Enter the price in INR" required>
        </div>
      </div>
      ...
      <a href="thrift.php" style="color:#000;font-family:'oswald';letter-spacing:2px;" class="btn btn-primary btn-block">Click here to start thrfting🛒</a>
  </form>
  </div>
